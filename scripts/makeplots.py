...
taurexval = np.array([-3.918, -6.732, -2.671, -3.722])
taurexunc = np.array([ 0.207,  0.719,  1.387,  0.482])
...
plt.errorbar(mols+0.1, chimeraval, yerr=[chimeraunc[:,0], chimeraunc[:,1]], 
             label='CHIMERA', fmt='o')
plt.errorbar(mols+0.2, taurexval,  yerr=taurexunc, 
             label='Tau-REx Stage-1', fmt='o')
...
plt.ylim(-14, 0)
plt.ylabel('Log Abundance', fontsize=14)
